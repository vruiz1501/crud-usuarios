...
interface DaoUsuario {
    ...
    @Query("UPDATE usuarios set pais=:pais, telefono=:telefono, correo=:correo WHERE usuario=:usuario")
    suspend fun actualizarUsuario(usuario: String, pais: String, telefono: String, correo: String)
